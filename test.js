...
const PIX = {
    id: {
        ...
        MerchantAccountInfomation:"26",
        MerchantAccountInfomationGui:"00",
        MerchantAccountInfomationKey:"01",
        MerchantAccountInformationDescription:"02",
        MerchantAccountInformationUrl:"25",
        ...
        MerchantName:"59",
        MerchantCity:"60",
        AdditionalFieldTemplate:"62",
        AdditionalFieldTemplateTxId:"05",
    }, 
    CRC16: s => {
        var crc = 0xFFFF;
        var j, i;
...
function payloadPix() {
    ...
    const key = "46338008840"
    const merchant_name = "codexfast" // max len(15)
    const merchant_city = "Santa Branca" // max len(15)
    const txid = "PAG2023TEST"
    const amount = 34.4
